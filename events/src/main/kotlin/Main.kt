...
object Main {
    ...
    fun main(args: Array<String>) {
        ...
        val isExternal = System.getenv("EVENTS_EXTERNAL_HOST") != null
            ...
            when {
                startService.succeeded() ->
                    WebClient.create(vertx, WebClientOptions().setSsl(isExternal))
                            ...
                            .addQueryParam(SERVICE_HOST, System.getenv("EVENTS_EXTERNAL_HOST")?.toString() ?: HOST)
                            .addQueryParam(SERVICE_PORT, if (isExternal) "443" else "10000")
                            .send { publishResult ->
